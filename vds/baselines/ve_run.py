...
from vds.baselines.common.cmd_util import common_arg_parser, parse_unknown_args, make_vec_env
...
def train(args, extra_args):
    ...
    from vds.baselines.her.ve_her import learn
...
def get_alg_module(alg, submodule=None):
    ...
    try:
        ...
        alg_module = import_module('.'.join(['vds', 'baselines', alg, submodule]))
    except ImportError:
        # then from rl_algs
