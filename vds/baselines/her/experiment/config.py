...
from vds.baselines.her.ddpg import DDPG
from vds.baselines.her.goal_sampler import make_goal_sampler_factory_random_init_ob
from vds.baselines.her.value_ensemble_v1 import ValueEnsemble
from vds.baselines.her.her_sampler import make_sample_her_transitions
from vds.baselines.bench.monitor import Monitor
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'vds.baselines.her.actor_critic:ActorCritic',
