...
import vds.baselines.common.tf_util as U
from vds.baselines.common import set_global_seeds, tf_util
from vds.baselines.common.mpi_moments import mpi_moments
from vds.baselines.common.mpi_fork import mpi_fork_run_as_root, mpi_fork
import vds.baselines.her.experiment.config as config
from vds.baselines.her.rollout import RolloutWorker
...
def learn(*, env_type, env, eval_env, plotter_env, total_timesteps, num_cpu, allow_run_as_root, bind_to_core,
    ...
    if policy_pkl is not None:
        ...
        eval_env.envs_op("set_test", test=True)
        if plotter_env is not None:
